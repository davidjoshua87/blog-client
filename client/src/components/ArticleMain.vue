...
<div class="main-page">
  <article>
    <HeaderNav :title="titleArticle" :description="descriptionBy"></HeaderNav>
    <div class="container">
      <div class="row">
        <sidebar></sidebar>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      Content:
                      <textarea class="form-control" placeholder=content type="text" v-model="contentArticle"></textarea>
                    </div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="comment-user">
                        <textarea rows="4" cols="55" v-model="newComment"></textarea>
...
export default {
  ...
  methods: {
    fetchArticlesData: function () {
      axios({
        method: 'get',
        url: `http://35.198.236.79/articles/${this.id}`
      }).then(data => {
    ...
    addComment: function () {
      axios.put(`http://35.198.236.79/articles/${this.id}`, {
        id: this.id,
